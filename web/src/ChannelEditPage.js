...
import {Alert, AutoComplete, Button, Card, Col, Input, InputNumber, Row, Select, Space} from "antd";
import {ApiOutlined, CheckCircleOutlined, CloseCircleOutlined, EyeInvisibleOutlined, EyeOutlined, SaveOutlined, ThunderboltOutlined} from "@ant-design/icons";
        ...
        <Row style={{marginTop: "20px"}}>
          ...
          <Col span={22}>
            <Input
              ...
              suffix={
                <span
                  onClick={this.toggleApiKeyVisible}
                  style={{cursor: "pointer", color: "#999"}}
                >
                  {this.state.apiKeyVisible ? <EyeInvisibleOutlined /> : <EyeOutlined />}
                </span>
              }
